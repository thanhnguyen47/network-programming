...
int main()
{
    ...
    addr.sin_addr.s_addr = inet_addr("192.168.0.118"); // host address 
...
int send_list()
{
    ...
    addr_data.sin_addr.s_addr = inet_addr("192.168.0.118"); // host address 
...
int download_file(char *remote_file)
{
    ...
    struct sockaddr_in addr_data;
    addr_data.sin_family = AF_INET;
    addr_data.sin_addr.s_addr = inet_addr("192.168.0.118");
    addr_data.sin_port = htons(port);
