...
int main()
{
    ...
    // dựa theo cấu trúc của json
    char *pos1 = strstr(buf, "temp_c"); // tìm kiếm vị trí đầu tiên của chuỗi temp_c
    char *pos2 = strchr(pos1, ':') + 1; // tìm kiếm ký tự dấu hai chấm bắt đầu từ pos1
